...
namespace CapavistaEF
{
    public partial class frmMDI : Form
    {
        ...
        private void reporteDeBitacoraToolStripMenuItem_Click(object sender, EventArgs e)
        {
            bit.user(txtUsuario.Text);
            bit.insert("Ingreso a Produccion", 3313);
            ReporteBitacora Repor = new ReporteBitacora();
        ...
        private void reportesProductosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            bit.user(txtUsuario.Text);
            bit.insert("Ingreso a Produccion", 3313);
            ReporteProducto Repor = new ReporteProducto();
            Repor.MdiParent = this;
            Repor.Show();
        }

        private void reporteDeProducciónToolStripMenuItem_Click(object sender, EventArgs e)
        {
            bit.user(txtUsuario.Text);
            bit.insert("Ingreso a Produccion", 3313);
            ReporteProduccion Repor = new ReporteProduccion();
            Repor.MdiParent = this;
            Repor.Show();
        }
    }
